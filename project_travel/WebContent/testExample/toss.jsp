...
<body>
	<button id="tossbutton" >결제하기</button>
	<script>
    // ------ 클라이언트 키로 객체 초기화 ------
    ...
    // ------ 결제창 띄우기 ------
	    tossPayments.requestPayment('카드', { // 결제수단 파라미터 (카드, 계좌이체, 가상계좌, 휴대폰 등)
		      ...
		      successUrl: 'http://localhost:8081/project_travel/mainPage.jsp', // 결제 성공 시 이동할 페이지(이 주소는 예시입니다. 상점에서 직접 만들어주세요.)
		      failUrl: 'http://localhost:8081/project_travel/mainPage.jsp', // 결제 실패 시 이동할 페이지(이 주소는 예시입니다. 상점에서 직접 만들어주세요.)
		    })
		    // ------결제창을 띄울 수 없는 에러 처리 ------
